...
See research/posting_time_of_day.md.
...
The split the first user set on 2026-08-05: creating or changing a search and pressing
...
def _moment_of(stamp: str) -> datetime | None:
    ...
    # at 12:50 in Tennessee read as 16:50, which then satisfied the 16:30
