...
Two of the first user's applications were LOST because their status existed in exactly one
...
alone would lose the fact that a job was applied to before it was denied. It
