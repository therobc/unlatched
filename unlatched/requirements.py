...
# live results: "For over 20 years, Northwind has empowered teams..." was
...
CLEARANCE = re.compile(
    ...
    # post against. Any federal search touching one hits these constantly and
    # they look nothing like the DoD wording.
