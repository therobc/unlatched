...
#
# EMPTY, and correctly so. Every entry it held was a legacy spelling from
# before the first public release, which no config in existence can carry.
# The mechanism stays for the first rename that comes after.
