...
def _is_dropped(tokens: list[str], phrase: str) -> bool:
    """The spec's drop rules, plus guards found by reading real mined output
    rather than assuming the spec's original three rules were sufficient:
...
def mine_report(corpus: list[str], resume_text: str = "",
    ...
    (spec default 2) drops phrases only one posting mentions - a single
