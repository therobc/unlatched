...
def accepted(kind: str | None, wanted: list[str] | None) -> tuple[bool, str]:
    ...
    A False here FLAGS the posting rather than discarding it. The first user, 2026-08-05,
    somebody open only to full time will still read a contract posting and
    part-time ones that surface and mark them passed himself. A person
