...
MEASURED BEFORE ENFORCING, across all five profiles on 2026-08-08: 10,387
stored job URLs and 219 careers URLs, 216 distinct hosts, every one of them
`https` and every one resolving to a public address. Not a single row in
...
def host_matches(host: str, domains: tuple[str, ...]) -> bool:
    """Subdomains count: jobs.linkedin.com is LinkedIn."""
...
# lives - LinkedIn's wrapper is on linkedin.com no matter which ATS it leads to.
#
# Reported by the collector author 2026-08-08 from the career_url backfill, where a naive
# off-site test rejected every LinkedIn row for exactly this reason:
#   linkedin.com/safety/go/?url=https%3A%2F%2Fapply%2Eworkable%2Ecom%2F...
