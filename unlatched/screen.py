...
def screen_job(job: Any, cfg: dict[str, Any], resume_text: str = "") -> dict[str, Any]:
    ...
    score = 60.0
    # THE SAME MATCHER THE GATE USED. A substring test stood here, so a
    # posting could pass _title_screen on title_wants and then be denied the
    # bonus for it: "IT HelpDesk Analyst" against "help desk" qualified and
    # scored 60 where an exact phrase scored 80. On a score-sorted list that
    # is the difference between the first screen and the third, and it fell
    # on exactly the postings the generous matcher exists to find.
