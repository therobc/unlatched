...
- **A status pipeline** - Applied, Interviewed, Offer, Accepted Offer, Hired,
  Offer Withdrawn, Declined Offer, No Offer, Rejection Email, No Response,
  Pass - with an optional note on every transition and a full history that a
  re-screen never touches.
