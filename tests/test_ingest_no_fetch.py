...
def test_the_supplied_row_is_stored_intact_when_nothing_is_fetched(con, reading_on):
    ...
    result = manual.add(
        ...
        title="Technology Operations Support Analyst", company="Facet",
        location="Remote - US", description="Support the operations team.",
        posted="2026-08-01",
        apply_url="https://apply.workable.com/facet/j/ABC123/?utm_source=linkedin",
    ...
    assert row["apply_url"] == "https://apply.workable.com/facet/j/ABC123"
...
def test_two_boards_pointing_at_one_application_agree_on_the_key(con, reading_on):
    ...
    manual.add(con, reading_on, LINKEDIN, title="Analyst", no_fetch=True,
               ...
               fetcher=fetcher)
    manual.add(con, reading_on, "https://apply.workable.com/facet/j/ABC123/",
