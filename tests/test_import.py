...
ROW = {
    ...
    "apply_url": ("https://www.linkedin.com/safety/go/?url="
                  "https%3A%2F%2Fapply%2Eworkable%2Ecom%2Ffacet%2Fj%2FABC123%2F"
...
def test_the_apply_destination_is_unwrapped_and_normalised_on_the_way_in(con, cfg):
    ...
    result = importer.import_row(con, cfg, ROW)
    assert result["apply_url"] == "https://apply.workable.com/facet/j/ABC123"
...
def test_a_senders_own_key_is_honoured(con, cfg):
    ...
    assert result["key"] == "imported:li:998877" or result["key"] == "li:998877"
...
def test_an_imported_row_and_a_collected_one_share_an_apply_key(con, cfg):
    """The whole point of carrying apply_url through the import: the LinkedIn
    ...
    assert imported["apply_url"] == links.normalise_apply_url(
        "https://apply.workable.com/facet/j/ABC123")
