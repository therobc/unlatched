...
The manual collect menu offers "all boards" and "seeded companies" as separate
actions, and the seeded list is refreshable on its own. That cannot be
expressed without knowing which employers were seeded, which is what
companies.origin records.
"""
