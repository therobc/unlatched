...
another - Facet's LinkedIn listing routes to apply.workable.com - so the same
job can arrive twice and only this field says so exactly.
...
WORKABLE = "https://apply.workable.com/facet/j/ABC123/"
