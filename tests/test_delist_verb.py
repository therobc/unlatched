...
The collector author owns closure detection for the rows her collector gathers, because
Unlatched re-detecting them would mean fetching the same site again on a
schedule - a second automated reader for no new information, which is the rule
