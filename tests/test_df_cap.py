"""A phrase appearing in more than MAX_DF documents is
boilerplate, not an identifier, and must not be used to match postings
together - the original defect merged eight unrelated roles into one
company because an EEO boilerplate phrase matched everything it touched.
"""
