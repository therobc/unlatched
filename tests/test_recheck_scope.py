...
def test_recheck_reads_nothing_when_the_setting_is_off(con, cfg):
    """Turned off HERE rather than taken from the default.

    The default shipped off until 2026-09-07 and this leaned on it, so the test
    named one thing - what off does - and silently asserted another. Setting it
    explicitly keeps the guarantee attached to the setting instead of to
