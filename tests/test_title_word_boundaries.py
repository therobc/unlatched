...
# ---- singular vs plural -------------------------------------------------
#
# A search asked for "human resources generalist" and the posting was titled
# "Human Resource Generalist". The exact role being hunted scored "title
# matches none of search.title_include" - the one answer certainly wrong.
