...
index attaches to the wrong job the next time the list is rebuilt - and the
wrong job looks like a perfectly ordinary row with a status on it. Import,
and every lookup, must go through the key alone.
"""
