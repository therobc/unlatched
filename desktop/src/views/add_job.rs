...
pub fn show(app: &mut UnlatchedApp, ctx: &egui::Context) {
    ...
    egui::Window::new("Add a job by link")
        ...
        .show(ctx, |ui| {
            ...
            // to work out from an empty row afterwards (decided 2026-08-08).
            // The setting ships ON since 2026-09-07, so this panel is now what
            // somebody who TURNED IT OFF sees rather than what a new install
            // shows - the switch stays offered inline either way, because
            // being told where a setting lives while you are mid-task is worse
            // than being able to change it.
