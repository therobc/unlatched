...
/// See the note in the engine's config.py: it ships off because of whose name
/// is on the public repository, not because the behaviour is indefensible, and
/// the app says so in three places rather than failing quietly.
