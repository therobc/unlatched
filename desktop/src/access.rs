...
//!
//! Required by the fleet build standard (`shared/hardprompts/build_standard.md`,
//! "Accessibility = testability"): every interactive egui widget gets a stable
//! accessible name, the native analog of a web `data-testid`. It is what a
//! screen reader reads, and it is how automation drives the app through Windows
//! UIA instead of by pixel position.
//!
