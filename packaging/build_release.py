...
def use_sandbox(dist: Path) -> None:
    ...
    Decided 2026-08-12, after sixteen Unlatched binaries accumulated on one
    machine: a harness executable has to be sandboxed, so that cleaning up
    after it cannot touch a finished product.
